    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[11px] font-mono">
        <div className="p-2 rounded-xl bg-slate-950/60 border border-slate-800 text-slate-400">
          <strong className="text-slate-200 block">Rule 4.1 & 4.2</strong>
          Resolve Exceptions & Credit
        </div>
        <div className="p-2 rounded-xl bg-slate-950/60 border border-slate-800 text-slate-400">
          <strong className="text-slate-200 block">Rule 4.3 & 4.4</strong>
          Financials & Horizon Lock
        </div>
        <div className="p-2 rounded-xl bg-slate-950/60 border border-slate-800 text-slate-400">
          <strong className="text-slate-200 block">Rule 4.5</strong>
          Strategic Tier Override Authority
        </div>
        <div className="p-2 rounded-xl bg-slate-950/60 border border-slate-800 text-slate-400">
          <strong className="text-slate-200 block">Rule 4.6 & 4.7</strong>
          Spot Restrictions & Commitment
        </div>
      </div>
